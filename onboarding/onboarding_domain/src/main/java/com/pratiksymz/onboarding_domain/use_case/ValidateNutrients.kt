package com.pratiksymz.onboarding_domain.use_case

import com.pratiksymz.core.R
import com.pratiksymz.core.util.UiText

/**
 * This class has only one functionality (use-case) to validate the nutrients ratio.
 */
class ValidateNutrients {
    ...
    /*
        Notify the ViewModel about the result of validation -> Success or not?
     */
    sealed class Result {
        data class Success(
